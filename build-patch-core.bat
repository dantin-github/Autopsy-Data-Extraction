...
set "CP2="
for %%j in ("%AUTOPSY%\platform\lib\org-openide-util.jar" "%AUTOPSY%\platform\lib\org-openide-util-lookup.jar" "%AUTOPSY%\platform\lib\org-openide-util-ui.jar" "%AUTOPSY%\platform\modules\org-openide-windows.jar" "%AUTOPSY%\autopsy\modules\org-sleuthkit-autopsy-core.jar") do (
    if exist "%%~j" set "CP2=!CP2!;%%~j"
)
for %%j in ("%AUTOPSY%\autopsy\modules\ext\sleuthkit-*.jar") do (
    if exist "%%~j" set "CP2=!CP2!;%%~j"
)
